...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.arrFrames = [[NSMutableArray alloc] init];
    
    for (int i=0; i<10; i++) {
        
        [self.arrFrames addObject:[NSString stringWithFormat:@"%d",i]];
    }
    ...
    UINavigationController *navContrller = [[UINavigationController alloc] initWithRootViewController:splashScreenViewController];
    
    navContrller.navigationBarHidden = YES;
